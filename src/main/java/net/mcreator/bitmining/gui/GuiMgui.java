...
package net.mcreator.bitmining.gui;
...
public class GuiMgui extends ElementsBitMining.ModElement {
	public static int GUIID = 1;
	public static HashMap guistate = new HashMap();
	public GuiMgui(ElementsBitMining instance) {
		super(instance, 2);
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		private void slotChanged(int slotid, int ctype, int meta) {
			if (this.world != null && this.world.isRemote) {
				BitMining.PACKET_HANDLER.sendToServer(new GUISlotChangedMessage(slotid, x, y, z, ctype, meta));
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("bitmining:textures/mgui.png");
		@Override
		...
		protected void drawGuiContainerForegroundLayer(int par1, int par2) {
			this.fontRenderer.drawString("PSU", 43, 20, -16777216);
		}
		...
		public void initGui() {
			...
			this.buttonList.add(new GuiButton(0, this.guiLeft + 115, this.guiTop + 38, 40, 20, "NEXT"));
		}

		@Override
		protected void actionPerformed(GuiButton button) {
			BitMining.PACKET_HANDLER.sendToServer(new GUIButtonPressedMessage(button.id, x, y, z));
